#!/usr/bin/env python
import concurrent.futures as cf  # FIX [BUG-05]: use ThreadPoolExecutor (paramiko not picklable)
import pathlib
import socket
...
class SshConnector:
    ...
    def ssh_brute_force(self, host):
        try:
            ...
            results_list = []
            try:
                with cf.ThreadPoolExecutor(max_workers=4) as executor:  # FIX [BUG-05]: was ProcessPoolExecutor
